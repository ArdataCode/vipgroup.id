...
class Prime_Slider_Loader {
	...
	public function register_site_scripts() {
		...
		if (prime_slider_is_widget_enabled('multiscroll')) {
			wp_register_script('jquery-multiscroll', BDTPS_ASSETS_URL . 'vendor/js/jquery.multiscroll.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			wp_register_script('easings', BDTPS_ASSETS_URL . 'vendor/js/jquery.easings.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
		}
		if (prime_slider_is_widget_enabled('pagepiling')) {
			wp_register_script('jquery-pagepiling', BDTPS_ASSETS_URL . 'vendor/js/jquery.pagepiling.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
		}
		if (prime_slider_is_widget_enabled('knily') or prime_slider_is_third_party_enabled('woolamp')) {
			wp_register_script('goodshare', BDTPS_ASSETS_URL . 'vendor/js/goodshare.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
		}
		...
		if (bdt_ps()->is__premium_only()) {
			...
			if (prime_slider_is_widget_enabled('astoria') or prime_slider_is_widget_enabled('paranoia') or prime_slider_is_widget_enabled('pieces')) {
				wp_register_script('anime', BDTPS_ASSETS_URL . 'vendor/js/anime.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			}
			if (prime_slider_is_widget_enabled('astoria') or prime_slider_is_widget_enabled('blog') or prime_slider_is_widget_enabled('crossroad') or prime_slider_is_widget_enabled('general') or prime_slider_is_widget_enabled('isolate') or prime_slider_is_widget_enabled('paranoia') or prime_slider_is_widget_enabled('prism') or prime_slider_is_widget_enabled('reveal') or prime_slider_is_widget_enabled('fluent') or prime_slider_is_widget_enabled('dragon') or prime_slider_is_widget_enabled('flogia') or prime_slider_is_widget_enabled('mount') or prime_slider_is_widget_enabled('sequester') or prime_slider_is_widget_enabled('woocommerce') or prime_slider_is_widget_enabled('woolamp')) {
				wp_register_script('gsap', BDTPS_ASSETS_URL . 'vendor/js/gsap.min.js', [], '3.3.0', true);
			}
			if (prime_slider_is_widget_enabled('blog') or prime_slider_is_widget_enabled('general') or prime_slider_is_widget_enabled('isolate') or prime_slider_is_widget_enabled('fluent') or prime_slider_is_widget_enabled('dragon') or prime_slider_is_widget_enabled('flogia') or prime_slider_is_widget_enabled('mount') or prime_slider_is_widget_enabled('sequester') or prime_slider_is_widget_enabled('woocommerce') or prime_slider_is_widget_enabled('woolamp')) {
				wp_register_script('split-text', BDTPS_ASSETS_URL . 'vendor/js/SplitText.min.js', ['gsap'], '3.3.0', true);
			}
			if (prime_slider_is_widget_enabled('crossroad')) {
				wp_register_script('charming', BDTPS_ASSETS_URL . 'vendor/js/charming.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			}
			if (prime_slider_is_widget_enabled('avatar')) {
				wp_register_script('splitting', BDTPS_ASSETS_URL . 'vendor/js/splitting.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			}
			if (prime_slider_is_widget_enabled('fluent')) {
				wp_register_script('mThumbnailScroller', BDTPS_ASSETS_URL . 'vendor/js/jquery.mThumbnailScroller.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			}
		}

		if (prime_slider_is_third_party_enabled('woocircle')) {
			wp_register_script('classie', BDTPS_ASSETS_URL . 'vendor/js/classie.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			wp_register_script('dynamics', BDTPS_ASSETS_URL . 'vendor/js/dynamics.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
		}
		if (prime_slider_is_widget_enabled('pieces')) {
			wp_register_script('pieces', BDTPS_ASSETS_URL . 'vendor/js/pieces.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
		}

		wp_register_script('bdt-parallax', BDTPS_ASSETS_URL . 'vendor/js/parallax.min.js', ['jquery'], null, true);

		if ('on' === $reveal_effects) {
			wp_register_script('anime', BDTPS_ASSETS_URL . 'vendor/js/anime.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
			wp_register_script('revealFx', BDTPS_ASSETS_URL . 'vendor/js/RevealFx.min.js', ['jquery', 'elementor-frontend'], BDTPS_VER, true);
		}
	}
	...
	public function enqueue_site_styles() {
		...
		wp_enqueue_style('bdt-uikit', BDTPS_ASSETS_URL . 'css/bdt-uikit' . $direction_suffix . '.css', [], '3.15.1');
		wp_enqueue_style('prime-slider-site', BDTPS_ASSETS_URL . 'css/prime-slider-site' . $direction_suffix . '.css', [], BDTPS_VER);
		wp_register_style('splitting', BDTPS_ASSETS_URL . 'vendor/css/splitting' . $direction_suffix . '.css', [], BDTPS_VER);
	}
	...
	public function enqueue_site_scripts() {
		...
		wp_enqueue_script('bdt-uikit', BDTPS_ASSETS_URL . 'js/bdt-uikit.min.js', ['jquery'], '3.15.1');
	...
	public function enqueue_admin_scripts() {
		wp_enqueue_script('ps-notice-js', BDTPS_ADMIN_URL . 'assets/js/ps-notice.js', ['jquery'], BDTPS_VER,  true);
	}
