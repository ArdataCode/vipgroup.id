...
class Reveal extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'title_width',
			[
				'label' => esc_html__('Width', 'bdthemes-prime-slider') . BDTPS_NC,
				'type'  => Controls_Manager::SLIDER,
				'size_units' => ['px', '%', 'vw'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => __('Arrows', 'bdthemes-prime-slider') . BDTPS_NC,
				'tab'       => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-reveal-slider .slide.slide--left i.eicon-arrow-left, {{WRAPPER}} .bdt-reveal-slider .slide.slide--right i.eicon-arrow-right' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'vw', 'em'],
				'selectors' => [
					'{{WRAPPER}} .bdt-reveal-slider .slide.slide--left i.eicon-arrow-left, {{WRAPPER}} .bdt-reveal-slider .slide.slide--right i.eicon-arrow-right' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		<?php
			...
			public function render_text($slide) {
				...
				<?php if ($slide['text'] && ('yes' == $settings['show_text'])) : ?>
					<div class="bdt-text <?php echo $text_hide_on_setup; ?>">
