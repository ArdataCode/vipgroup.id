...
class Flexure extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_count_hide',
			[
				'label'   => esc_html__('Hide Title Count Text', 'bdthemes-prime-slider') . BDTPS_NC,
				'type'    => Controls_Manager::SWITCHER,
				'selectors' => [
	...
	public function render() {
        ...
        if (('on' === $reveal_effects) && ('yes' === $settings['reveal_effects_enable'])) {
            ...
            $this->add_render_attribute('ps-flexure', 'data-reveal-enable', $settings['reveal_effects_enable']);
					...
					<div>
						...
						<div class="bdt-ps-flexure-description bdt-position-small bdt-position-<?php echo esc_attr($settings['title_position']) ?>">
								...
								<?php if ( $item['ps_flexure_title'] && ( 'yes' == $settings['show_title'] ) ) : ?>
									<<?php echo Utils::get_valid_html_tag($settings['title_tags']); ?> <?php $this->print_render_attribute_string('bdt-ps-flexure-title'); ?> data-reveal="reveal-active" data-label="<?php echo str_pad( $tab_count, 2, '0', STR_PAD_LEFT); ?>">
				...
				<div id="<?php echo esc_attr($tab_id); ?>" <?php echo ( $this->get_render_attribute_string( 'ps-flexure-content' ) ); ?>>
					...
					<?php if ( $item['ps_flexure_content'] && ( 'yes' == $settings['show_content'] ) ) : ?>
						<div class="bdt-ps-flexure-text-wrapper">
							<span class="bdt-custom-divider reveal-muted" data-label="<?php echo str_pad( $tab_count, 2, '0', STR_PAD_LEFT); ?>"></span>
