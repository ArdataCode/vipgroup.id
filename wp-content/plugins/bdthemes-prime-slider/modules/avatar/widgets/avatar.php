...
namespace PrimeSlider\Modules\Avatar\Widgets;
...
class Avatar extends Widget_Base
{
    ...
    protected function render_header()
    {
        ...
        if (('on' === $reveal_effects) && ('yes' === $settings['reveal_effects_enable'])) {
            ...
            $this->add_render_attribute('prime-slider-avatar', 'data-reveal-enable', $settings['reveal_effects_enable']);
		...
		<div <?php $this->print_render_attribute_string('prime-slider');?>>
			<div <?php $this->print_render_attribute_string('prime-slider-avatar');?>>
				...
				<div class="bdt-hero-swiper swiper">
    ...
    public function rendar_item_image($slide) {
		...
		if (!$thumb_url) {
			printf('<img src="%1$s" alt="%2$s" class="bdt-image-wrap reveal-muted">', $slide['image']['url'], esc_html($slide['title']));
		} else {
