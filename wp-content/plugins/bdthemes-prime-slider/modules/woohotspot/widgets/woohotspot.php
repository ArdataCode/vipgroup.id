...
namespace PrimeSlider\Modules\Woohotspot\Widgets;
...
class Woohotspot extends Widget_Base
{
    ...
    {
        return ['prime-slider-font', 'ps-woohotspot'];
    }

    public function get_script_depends()
    {
        return ['ps-woohotspot'];
    }
    ...
    protected function register_controls()
    {
        ...
        //     [
        //         'label' => esc_html__('Hotspots', 'bdthemes-prime-slider'),
        //     ]
        // );
        ...
        $this->start_controls_section(
            'section_dropbar_option',
            [
                'label'     => esc_html__('Hotspot Settings', 'bdthemes-prime-slider'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'bottom-left',
                'options' => prime_slider_drop_position(),
            ]
        );
        ...
        $this->add_control(
            'drop_mode',
            [
                'label'   => esc_html__('Mode', 'bdthemes-prime-slider'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'hover',
                'options' => [
                    'click'    => esc_html__('Click', 'bdthemes-prime-slider'),
                    'hover'  => esc_html__('Hover', 'bdthemes-prime-slider'),
                ],
            ]
        );
        ...
        $this->add_control(
            'stretch',
            [
                'label'     => esc_html__('Stretch', 'bdthemes-prime-slider'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'null',
                'options' => [
                    'null' => esc_html__('None', 'bdthemes-prime-slider'),
                    'true' => esc_html__('Full', 'bdthemes-prime-slider'),
                    'x'    => esc_html__('X - Horizontal', 'bdthemes-prime-slider'),
                    'y'    => esc_html__('Y - Vertical', 'bdthemes-prime-slider'),
                ],
            ]
        );
        ...
        $this->add_control(
            'drop_flip',
            [
                'label' => esc_html__('Flip Dropbar', 'bdthemes-prime-slider'),
        ...
        $this->add_control(
            'drop_offset',
            [
                'label'   => esc_html__('Dropbar Offset', 'bdthemes-prime-slider'),
                'type'    => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_control(
            'target',
            [
                'label' => esc_html__('Target', 'bdthemes-prime-slider'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'title' => esc_html__('Add your custom class WITHOUT the dot. e.g: my-class', 'bdthemes-prime-slider'),
        ...
        $this->add_control(
            'inset',
            [
                'label' => esc_html__('Inset', 'bdthemes-prime-slider'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'boundary',
            [
                'label' => esc_html__('Boundary', 'bdthemes-prime-slider'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'bdt-animation-fade' => esc_html__('Fade', 'bdthemes-prime-slider'),
                    ...
                    'reveal-top'    => esc_html__('Reveal Top', 'bdthemes-prime-slider'),
                    'reveal-bottom' => esc_html__('Reveal Bottom', 'bdthemes-prime-slider'),
                    'reveal-left'   => esc_html__('Reveal Left', 'bdthemes-prime-slider'),
                    'reveal-right'  => esc_html__('Reveal Right', 'bdthemes-prime-slider'),
                ],
            ]
        );
        ...
        $this->add_control(
            'animate_out',
            [
                'label' => esc_html__('Animate Out', 'bdthemes-prime-slider'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'drop_duration',
            [
                'label'   => esc_html__('Animation Duration', 'bdthemes-prime-slider'),
                'type'    => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 200,
                ],
        ...
        $this->add_control(
            'drop_show_delay',
            [
                'label'   => esc_html__('Show Delay', 'bdthemes-prime-slider'),
                'type'    => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0,
                ],
        ...
        $this->add_control(
            'drop_hide_delay',
            [
                'label'   => esc_html__('Hide Delay', 'bdthemes-prime-slider'),
                'type'    => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 800,
                ],
        ...
        $this->add_control(
            'transition',
            [
                'label'   => esc_html__('Transition', 'bdthemes-prime-slider'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'slide',
                'options' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .bdt-woohotspot-content',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-woohotspot-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-woohotspot-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'    => [
                    '{{WRAPPER}} .bdt-woohotspot-content' => 'text-align: {{VALUE}}',
                ],
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-woohotspot-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-woohotspot-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-woohotspot-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-woohotspot-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-woohotspot-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-woohotspot-text',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-woohotspot-price' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-woohotspot-price' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-woohotspot-price',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link:hover svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link:hover',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdt-prime-slider-woohotspot .bdt-woohotspot-link:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('H O V E R', 'bdthemes-prime-slider'),
...
?>
    ...
    ?>
        <?php if ($marker['product_price']) : ?>
            <div class="bdt-woohotspot-price"><?php echo esc_html($marker['product_price']); ?></div>
        <?php endif; ?>
    <?php
    }
    ...
    ?>
        <?php if ($marker['two_product_price']) : ?>
            <div class="bdt-woohotspot-price"><?php echo esc_html($marker['two_product_price']); ?></div>
        <?php endif; ?>
    <?php
    }
    ...
    ?>
        <?php if ($marker['three_product_price']) : ?>
            <div class="bdt-woohotspot-price"><?php echo esc_html($marker['three_product_price']); ?></div>
        <?php endif; ?>
    <?php
    }
    ...
    ?>
        <?php if ($marker['product_text']) : ?>
            <div class="bdt-woohotspot-text"><?php echo wp_kses_post($marker['product_text']); ?></div>
        <?php endif; ?>
    <?php
    }
    ...
    ?>
        <?php if ($marker['two_product_text']) : ?>
            <div class="bdt-woohotspot-text"><?php echo wp_kses_post($marker['two_product_text']); ?></div>
        <?php endif; ?>
    <?php
    }
    ...
    ?>
        <?php if ($marker['three_product_text']) : ?>
            <div class="bdt-woohotspot-text"><?php echo wp_kses_post($marker['three_product_text']); ?></div>
        <?php endif; ?>
    <?php
    }
            ...
            foreach ($settings['markers'] as $marker) {
                ...
                $this->add_render_attribute(
                    [
                        'drop-settings' => [
                            'id'       => $id . rand(10, 100),
                            'class'    => 'bdt-card bdt-card-body bdt-card-default bdt-woohotspot-content',
                            'data-bdt-drop' => [
                                wp_json_encode([
                                    ...
                                    "target"     => $settings["target"] ? '!.' . $settings["target"] : false,
                                    "inset"      => $settings["inset"] ? true : false,
    ...
    ?>
        ...
        <?php if (!empty($settings['image']['url'])) : ?>
            <div class="swiper-slide bdt-item">
                <div class="bdt-flex"><?php $this->render_item_content(); ?></div>
            </div>
        <?php endif; ?>

        <?php if (!empty($settings['two_image']['url'])) : ?>
            <div class="swiper-slide bdt-item">
                <div class="bdt-flex"><?php $this->render_item_two_content(); ?></div>
            </div>
        <?php endif; ?>

        <?php if (!empty($settings['three_image']['url'])) : ?>
            <div class="swiper-slide bdt-item">
                <div class="bdt-flex"><?php $this->render_item_three_content(); ?></div>
            </div>
        <?php endif; ?>
    <?php
    }
    ...
    ?>
        ...
        <?php if ($settings['show_navigation_arrows']) : ?>
            <div <?php $this->print_render_attribute_string('prime-slider-arrows'); ?>>
                <a href="" class="bdt-navigation-prev bdt-woohotspot-slidenav">
                    <i class="ps-wi-arrow-left-<?php echo esc_html($settings['nav_arrows_icon']); ?>" aria-hidden="true"></i>
                </a>
                <a href="" class="bdt-navigation-next bdt-woohotspot-slidenav">
