...
namespace PrimeSlider\Modules\Prism\Widgets;
...
class Prism extends Widget_Base {
	...
	protected function register_controls() {
		...
		// 	[
		// 		'label'     => __('Slide Image', 'bdthemes-prime-slider'),
		// 		'tab'       => Controls_Manager::TAB_STYLE,
		// 	]
		// );
		...
		// $this->start_controls_section(
		// 	'section_style_slide_count',
		// 	[
		// 		'label'     => __('Slide Count', 'bdthemes-prime-slider'),
		// 		'tab'       => Controls_Manager::TAB_STYLE,
		...
		// 	Group_Control_Background::get_type(),
		// 	[
		// 		'name'      => 'oreview_image_overlay_background',
...
public function render_slides_loop() {
	...
	<div class="slide">
		...
		<div class="preview">
			...
			<<?php echo  Utils::get_valid_html_tag($settings['preview_title_html_tag']); ?> class="preview__title">
				<?php $this->render_preview_title($slide); ?>
			</<?php echo Utils::get_valid_html_tag($settings['preview_title_html_tag']); ?>>
			...
			<?php if ('yes' == $settings['show_count']) : ?>
				<span class="slide__number"><?php echo str_pad( $count, 2, '0', STR_PAD_LEFT); ?></span>
			<?php endif; ?>
