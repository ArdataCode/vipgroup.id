...
class Knily extends Widget_Base {
    ...
    public function get_script_depends() {
		...
		if ('on' === $reveal_effects) {
            return ['anime', 'revealFx', 'ps-knily', 'goodshare'];
		} else {
    ...
    public function render_image($post_id, $size) {
        ...
        if (!$image_src) {
            printf('<img src="%1$s" alt="%2$s" class="bdt-knily-img swiper-lazy">', $placeholder_image_src, esc_html(get_the_title()));
        } else {
    ...
    ?>
        <div class="bdt-knily-desc" data-reveal="reveal-active" data-swiper-parallax-y="-80" data-swiper-parallax-duration="600">
            <?php
            if (has_excerpt()) {
                the_excerpt();
            } else {
    ...
    ?>
        <div class="bdt-knily-category" data-reveal="reveal-active" data-swiper-parallax-y="-120" data-swiper-parallax-duration="400">
    ...
    protected function render_header() {
		...
		if (('on' === $reveal_effects) && ('yes' === $settings['reveal_effects_enable'])) {
			...
			$this->add_render_attribute('prime-slider-knily', 'data-reveal-enable', $settings['reveal_effects_enable']);
    ...
    ?>
        <div class="bdt-prime-slider">
            ...
            ?>
            <div thumbsSlider="" class="swiper-container swiper bdt-knily-thumbs">
                <div class="swiper-wrapper">
                    <?php
                    $i = 1;
                    while ($wp_query->have_posts()) {
