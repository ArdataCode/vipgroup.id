        ...
        ?>
            ...
            <div <?php $this->print_render_attribute_string('social-icon'); ?>>
                ...
                <?php
                    ...
                    <a href="<?php
                                echo esc_url($link['social_link']); ?>" target="_blank" <?php
                    ...
                    <span <?php
                        ...
                        <span <?php
                                $this->print_render_attribute_string('text'); ?>><?php
                                                                                    echo esc_html($settings['button_text']); ?><span class="bdt-slide-btn-icon"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="arrow-right">
